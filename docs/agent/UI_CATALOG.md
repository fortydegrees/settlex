...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Foundations | Brand foundations | `app/globals.css` | Product-wide | Default; reduced motion | CSS tokens | Token samples; normal/reduced reviewed | Desktop; mobile reviewed | Covered | None |
...
| Components | Overlays | `app/ui/Dialog.js`, `AlertDialog.js`, `Popover.js`, `MetaDisclosure.js`, `Tooltip.js` | Product-wide | Open; closed; confirm; destructive | Props | Open; close; dismiss; focus; normal/reduced reviewed | Desktop; mobile reviewed | Covered | None |
...
| Alerts & Recovery | Match-alert control | `app/catana/matchAlerts/MatchAlertControl.js` | Account menu/search rescue | Off; active; paused; blocked; unsupported; install required; pending; error | `matchAlertState.js` | Action feedback; normal/reduced reviewed | Desktop; mobile reviewed | Covered | None |
