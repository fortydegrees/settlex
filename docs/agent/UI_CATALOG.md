...
| Account & Identity | Account menu | `app/catana/home/HomeTableClient.js` | Homepage top chrome | Signed out; guest; claimed; alert states; pending; error | Component and match-alert helper | Popover open/close | Both | Covered | Extract |
...
| Alerts & Recovery | Match-alert control | `app/catana/home/HomeTableClient.js` | Account menu/search rescue | Off; active; paused; blocked; unsupported; install required; pending; error | `matchAlertState.js` | Action feedback | Both | Covered | Extract |
