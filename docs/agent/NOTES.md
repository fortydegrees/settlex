...
- use Tailwind-supported opacity suffixes on this module's glass/CTA classes. Values such as `bg-white/74`, `bg-white/78`, or `bg-white/88` are not generated by the current Tailwind config and make the chip/button render transparent.
