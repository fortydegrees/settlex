...
- when a visible timer reaches displayed `0:05` or lower, keep urgency local to the embedded timer segment. Use rose/danger glass and text glow plus the `turn-control-timer-low-pulse` hook; do not tint or animate the whole status strip.
