...
- `docs/agent/skills/catana-brand/SOUND_DESIGN_GUIDE.md` (the shipped sound identity: family grammar, audition-first workflow, wiring architecture — read before any audio work)
