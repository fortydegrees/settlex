...
export class Board {
  constructor(spec, isEmpty = false) {
    this.idCounter = 0;
    this.tiles = this.generateBoard(spec, isEmpty);
    this.nodes = {};
    this.edges = {};
    //only get nodes for land tiles
    if (!isEmpty){
  ...
  generateStandardHexes(shape, radius) {
